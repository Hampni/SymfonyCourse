...
class CheckoutController extends AbstractController
{
     ...
     * @Route("/checkout")
     */
    public function chechout(Request $request, ProductRepository $repo, SessionInterface $session, MailerInterface $mailer): Response
    {
    ...
    public function sendEmailConfirmation(Order $order, MailerInterface $mailer)
    {
        $email = (new TemplatedEmail())
            ->from('magnus9044@gmail.com')
